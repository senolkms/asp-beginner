...
<%final1=request.form("final1")
final2=request.form("final2")%>
...
<%Set rs= conn.Execute("SELECT * FROM tbl_ogrenci WHERE final>=" & final1 & " AND final<=" & final2 )%>
<!--Set rs= conn.Execute("SELECT * FROM tbl_ogrenci WHERE final BETWEEN " & final1 & " AND " & final2)-->
